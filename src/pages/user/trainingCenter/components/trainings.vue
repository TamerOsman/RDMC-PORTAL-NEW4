    ...
    <v-sheet class="py-5 fill-height" color="background">
        ...
        <v-card color="background" elevation="0">
            ...
            <v-container>
                <v-row>
                    <v-col>
                        <v-select v-model="groupBy1Value" class="w-auto" density="compact" hide-details :items="[
                            'No group',
                            { title: 'Training Title', value: 'trainingTitle' },
                            { title: 'Created By', value: 'createdBy' },
                            { title: 'Creation Date', value: 'creationDate' },
                            { title: 'Trainees Type', value: 'traineesType' },
                            { title: 'Training End Date', value: 'trainingEndDate' },
                ...
                <v-row>
                    <v-col class="mx-auto" style="max-width: 80vw;">
                        <v-data-table class="bg-transparent mt-12 overflow-auto" density="compact" :group-by="groupBy1"
                            :headers="[
                                { title: 'trainingTitle', key: 'trainingTitle' },
                                { title: 'createdBy', key: 'createdBy' },
                                { title: 'creationDate', key: 'creationDate' },
                                { title: 'traineesType', key: 'traineesType' },
                                { title: 'trainingEndDate', key: 'trainingEndDate' },
                                { title: 'trainingLangs', key: 'trainingLangs' },
                                { title: 'trainingStartDate', key: 'trainingStartDate' },
                                { title: 'trainingStatus', key: 'trainingStatus' },

                                // { title: 'trainingURL', key: 'trainingURL' },
